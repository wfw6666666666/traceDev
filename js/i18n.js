...
(function () {
  ...
  const I18N = {
    ...
    'zh-TW': {
      ...
      dashboard: { overview: '資源概覽', videosDescription: '嵌入式開發、單片機、STM32 等技術教學，從入門到進階', viewResources: '查看全部資料', quickAccess: '快速入口', commonEntry: '常用入口', hardware: '開發板', published: '已發布', recent: '最近更新', recentHint: '依最近發布的教學排序', videosCount: '個影片', activity: '最近動態', newVideo: '新增教學影片', libraryUpdated: '資料庫已更新', productUpdated: '店鋪商品上新', resourceStatus: '資源狀態', organized: '已整理', storageHint: '影片、工程檔案與學習筆記集中歸檔' },
    ...
    ja: {
      ...
      dashboard: { overview: 'リソース概要', videosDescription: '組み込み開発、マイコン、STM32 の入門から実践までのチュートリアル', viewResources: 'すべての資料を見る', quickAccess: 'クイックアクセス', commonEntry: 'よく使う入口', hardware: 'ハードウェア', published: '公開済み', recent: '最近の更新', recentHint: '新しいチュートリアル順', videosCount: '本', activity: '最近の動き', newVideo: '新しい動画', libraryUpdated: '資料を更新', productUpdated: '商品を追加', resourceStatus: 'リソース状態', organized: '整理済み', storageHint: '動画、プロジェクト、学習ノートをまとめて管理' },
    ...
    ko: {
      ...
      dashboard: { overview: '자료 개요', videosDescription: '임베디드 개발, 마이크로컨트롤러, STM32 입문부터 실전까지의 튜토리얼', viewResources: '전체 자료 보기', quickAccess: '빠른 이동', commonEntry: '자주 사용하는 메뉴', hardware: '하드웨어', published: '게시됨', recent: '최근 업데이트', recentHint: '최신 튜토리얼 순서', videosCount: '개 영상', activity: '최근 활동', newVideo: '새 튜토리얼', libraryUpdated: '자료실 업데이트', productUpdated: '상품 등록', resourceStatus: '자료 상태', organized: '정리 완료', storageHint: '영상, 프로젝트 파일, 학습 노트를 한곳에서 관리' },
